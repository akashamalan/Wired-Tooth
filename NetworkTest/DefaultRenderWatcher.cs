...
///
/// WasapiOut binds one device when it is constructed. If the user
/// changes their output device, playback keeps feeding an endpoint nobody is
/// listening to -- silent, with no exception anywhere, which is the most
/// confusing possible failure because everything still reports healthy.
///
